...
const juno = async (method, endpoint, data = {}, config = {}) => {
  const instance = await axios.create({
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX25hbWUiOiJkZW5pc2Uuc2lsdmFAbGlua2FwaS5jb20uYnIiLCJzY29wZSI6WyJhbGwiXSwiZXhwIjoxNjIzOTQzMjAxLCJqdGkiOiJSWm9LZzVxU0N4TG8xbGZTcDcxR1ZHQlhjdVEiLCJjbGllbnRfaWQiOiJSSmVXcDY5aUxBaXBpdEl0In0.QhxEyhnQ8z_PduNVfbtdplXefl9wc6CRgnz6AudC_U2d7PaPZtsXPWkOioAy_RiHw966mIZecuCFutXmCdihJoeHwt7NziNHsDYZz29CpygM1NNWVZ7wGJH8MoodapYdPX6QtfNOENPxTSBf0aLCkL6w6MgEeNBBseVeTJCFhwNhGxxilk_aKaAO6OvOjp2DvYQjaxnPdMDhm3eU3xPbMPZl9wFxXtYwzC_7LOGKLdWzNTeIJ0ZOnIa1oHeNe96NtDVYL8lVwAI-9d1W_99bM3mkqYMKjHEuOPrDFokkCfLKpPX2xeJWV_X52o5yr12J_cz292_xjvRE9RrP7n61TA",
    },
  });
