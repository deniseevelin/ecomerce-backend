...
const juno = async (method, endpoint, data = {}, config = {}) => {
  const instance = await axios.create({
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX25hbWUiOiJkZW5pc2Uuc2lsdmFAbGlua2FwaS5jb20uYnIiLCJzY29wZSI6WyJhbGwiXSwiZXhwIjoxNjIzODU0MTAxLCJqdGkiOiJ1cDMzNjkwRlFkUTVpalo3VjZtMl81dGhXOVkiLCJjbGllbnRfaWQiOiJSSmVXcDY5aUxBaXBpdEl0In0.jevFv8gGdbS1k84ATaDr2xC-MJWHpxjCpLk-gQFyPQHyeXGnyOw6OH82BMVKSIX7CxHwXbAc7EgH9vuzG29MKbOk0Ww1qVNARIug7Qt1MMhsjArrJQCqUBl6h59QK1RmEo7hCFZl4ff04Ftlwryb2V90NGalSt6E3DHrNKNbANjYw-coA4Us1ISO6q1h1JkW2L6CS2m42C1y_glde1DvphzzKWI5bwWEc1NpbIYFoAcbk6Ds8oFpwu9q8VEs9FpYAm3XE5SSlVYu8OG49X46kuXjJF8ReWYvTHoqiiwIwYvLCcNjhvkYn2lM9gaaQCxOE1w7IuRnltJguGw8p1r3gA",
    },
  });
